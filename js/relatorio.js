$(document).ready(function(){
		...
		function (data){
			...
			for (var key in array) 
			{
				if (array.hasOwnProperty(key)) 
				{
					...
					var reclamacao = array[key]["reclamacao"];
					var resposta = array[key]["resposta"];
					if(typeof reclamacao == 'undefined' || reclamacao == null)
						reclamacao = "";
					if(typeof resposta == 'undefined' || reclamacao == null)
						resposta = "";
					//console.log(typeof resposta);		

					createCard(n_quartos,n_banheiros,area,cep,rua,bairro,cidade,email_contato,tel_contato,preco,tipo,imagem1,id_imovel,reclamacao,resposta)
				}
			}
		});
	}	
		...
		function (data){
			...
			for (var key in array) 
			{
				if (array.hasOwnProperty(key)) 
				{
					...
					createCard2(n_quartos,n_banheiros,area,cep,rua,bairro,cidade,email_contato,tel_contato,preco,tipo,imagem1,id_imovel,reclamacao,resposta)
				}
			}
		});
	}
	...
	function createCard(quartos,banheiros,area,cep,rua,bairro,cidade,email_contato,tel_contato,preco,tipo,imagem1,id_imovel,reclamacao,resposta){
		...
		var li_reclamacao = document.createElement("li");
		var li_resposta = document.createElement("li");
		...
		li_reclamacao.classList.add("list-group-item");
		li_resposta.classList.add("list-group-item");
		//append no <ul>
		...
		ul.append(li_tel);
		ul.append(li_preco);
		ul.append(li_reclamacao);
		ul.append(li_resposta);
		...
		var b_8 = document.createElement("b");
		var b_9 = document.createElement("b");
		...
		var t_8 = document.createTextNode("Reclamacao: ");
		var t_9 = document.createTextNode("Resposta: ");
		...
		var s_8 = document.createElement("span");
		var s_9 = document.createElement("span");
		...
		li_preco.append("R$ ");
		li_preco.append(s_7);
		li_reclamacao.append(b_8);
		li_reclamacao.append(s_8);
		li_resposta.append(b_9);
		li_resposta.append(s_9);
		...
		if(reclamacao != "")
		{
			...
			var t_btn = document.createTextNode("Responder");
			btn.append(t_btn);
	...
	function createCard2(quartos,banheiros,area,cep,rua,bairro,cidade,email_contato,tel_contato,preco,tipo,imagem1,id_imovel,reclamacao,resposta){
		//seletor da seção de resultados
    	var results = $("#re");
		...
		btn.onclick = function () {
			...
			//console.log(id_imovel);
			sessionStorage.setItem('id_imovel', id_imovel);
			window.location.replace("reclamar");   
			return false;
};
		var t_btn = document.createTextNode("Reclamar");
		btn.append(t_btn);
		card_body_2.append(btn);
		card.append(card_body_2);
