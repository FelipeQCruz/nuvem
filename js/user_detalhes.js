$(document).ready(function(){
		...
		function (data){
			...
			for (var key in array) 
			{
				if (array.hasOwnProperty(key)) 
				{
					...
					var imagem2 = array[key]["imagem2"];
					var imagem3 = array[key]["imagem3"];
					createCard1(n_quartos,n_banheiros,area,cep,rua,bairro,cidade,email_contato,tel_contato,preco,tipo,imagem1,imagem2,imagem3,id_imovel)
				}
			}
		});
	});	
	...
	function createCard1(quartos,banheiros,area,cep,rua,bairro,cidade,email_contato,tel_contato,preco,tipo,imagem1,imagem2,imagem3,id_imovel){
		...
		card5.setAttribute("style","width: 18rem; margin-top: 3rem;");
		
    	var card6 = document.createElement("div");
		card6.classList.add("card");
		card6.setAttribute("style","width: 18rem; margin-top: 3rem;");
		...
		img.setAttribute("src","data:image/jpeg;base64,"+imagem2);
		img.setAttribute("style","height: 255px");
		card5.append(img2);/*
		var img3 = document.createElement("img");
		img.setAttribute("src","data:image/jpeg;base64,"+imagem3);
		img.setAttribute("style","height: 255px");
		card6.append(img3);*/
		...
		{		
			...
			btn.onclick = function () {
				...
				window.location.replace("alugar");   
				return false;
			};
